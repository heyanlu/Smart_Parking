...
public interface IParkingManager {
   ...
   * @param vehicleType The type of vehicle (edu.northeastern.sv.khoury.smartPark.model.Car, edu.northeastern.sv.khoury.smartPark.model.Motorbike, edu.northeastern.sv.khoury.smartPark.model.Truck).
  ...
  /**
   * Creates a new edu.northeastern.sv.khoury.smartPark.model.Vehicle object based on the given license plate and vehicle type.
   * @param licensePlate The licensePlate of vehicle.
   * @param type The type of vehicle (edu.northeastern.sv.khoury.smartPark.model.Car, edu.northeastern.sv.khoury.smartPark.model.Motorbike, edu.northeastern.sv.khoury.smartPark.model.Truck).
   * @return A new edu.northeastern.sv.khoury.smartPark.model.Vehicle object.
   */
